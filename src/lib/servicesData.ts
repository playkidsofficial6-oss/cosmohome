...
export const SERVICES_DATA: Record<string, ServiceData> = {
  "hifu": {
    ...
    description: "Lift, tighten, and redefine your facial contours with High-Intensity Focused Ultrasound (HIFU). This advanced treatment stimulates your body's natural collagen production for firmer, smoother, and younger-looking skinâ€”without surgery or downtime.",
    heroRating: "4.8 Â· Rated by 190+ patients",
    heroImage: "/services/hifu/1.webp",
    performedByLabel: "ðŸ‘©â€âš•ï¸ Performed by",
    performedByName: "Doctor-Supervised Care",
    performedBySub: "Safe â€¢ Personalised â€¢ Professional",
    stats: [
      { n: "1â€“2", l: "Sessions recommended" },
      { n: "0", l: "Days downtime" },
    ...
    benefits: [
      { icon: "ðŸ§¬", b: "Deep Collagen Activation", d: "Stimulates collagen where structural support begins." },
      { icon: "ðŸ“ˆ", b: "Tightens & Lifts Over Time", d: "Gradual improvement with beautifully natural results." },
      { icon: "âœ‚ï¸", b: "No Surgery or Downtime", d: "Return to normal activities immediately." },
      { icon: "ðŸ›¡ï¸", b: "Safe & Clinically Proven", d: "A non-invasive treatment trusted worldwide." }
    ],
    ...
    deviceSub: "MEDICAL-GRADE â€¢ PRECISION â€¢ PERSONALISED CARE",
    ...
    timelineItems: [
      ...
      { when: "Day 3â€“7", what: "Collagen stimulation begins beneath the skin. While changes remain subtle, your skin starts feeling firmer and more resilient." },
      { when: "Week 4â€“8", what: "Visible lifting becomes more noticeable as collagen production increases. Facial contours appear smoother, tighter, and better defined." },
    ...
    ctaDesc: "Your consultation includes a comprehensive skin assessment, personalised treatment planning, and expert guidance tailored to your aesthetic goalsâ€”designed to deliver safe, natural-looking results with confidence.",
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹35,000 / session" },
      { label: "Duration", val: "60â€“90 minutes" },
      { label: "Recommended", val: "1â€“2 sessions" },
  ...
  "hydrafacial-medifacial": {
    ...
    heroRating: "4.9 Â· Rated by 380+ patients",
    ...
    stats: [
      ...
      { n: "0", l: "Days downtime" },
      { n: "30â€“45 Min", l: "Treatment duration" },
      { n: "All Skin Types", l: "Safe & suitable" }
    ],
    whatIsThisTag: "WHAT IS HYDRAFACIAL?",
    whatIsThisTitle: "This is not",
    whatIsThisEmphasized: "a salon facial.",
    whatIsThisDesc1: "Hydrafacial is a medical-grade skin rejuvenation treatment that goes beyond traditional facials. Using advanced vortex technology, it deeply cleanses, gently exfoliates, removes impurities, and infuses the skin with nourishing serumsâ€”all in one relaxing treatment.",
    ...
    benefits: [
      { icon: "ðŸ§¼", b: "Deep Cleansing", d: "Removes excess oil, debris, and impurities from congested pores." },
      { icon: "ðŸ’§", b: "Intense Hydration", d: "Infuses antioxidant-rich serums for healthier, smoother skin." },
      { icon: "âœ¨", b: "Instant Glow", d: "Leaves the skin visibly refreshed, brighter, and more radiant." },
      { icon: "ðŸŒ¿", b: "Suitable for All Skin Types", d: "Gentle, non-invasive treatment with no downtime." }
    ],
    ...
    deviceName: "HydraFacial MDÂ® Elite",
    deviceSub: "MEDICAL-GRADE â€¢ ADVANCED HYDRATION â€¢ SKIN REJUVENATION",
    deviceDesc: "HydraFacial MDÂ® Elite combines deep cleansing, gentle exfoliation, painless extraction, and intensive serum infusion in one advanced treatment. Using patented Vortex-FusionÂ® technology, it removes impurities while delivering nourishing ingredients that instantly improve skin hydration, clarity, and radiance.",
    deviceFeatures: ["Vortex-FusionÂ® Technology", "Medical-Grade Hydration", "Gentle Extraction", "Customised Serum Infusion"],
    ...
    timelineItems: [
      ...
      { when: "DAY 2â€“7", what: "Hydration levels improve, pores appear cleaner, and your complexion looks brighter and more refreshed." },
      { when: "WEEK 2â€“4", what: "Skin texture becomes smoother, tone appears more even, and overall radiance continues to improve." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹15,000 / session" },
      { label: "Duration", val: "45â€“75 minutes" },
      { label: "Recommended", val: "3â€“6 sessions" },
      { label: "Frequency", val: "Every 4â€“6 weeks" },
      { label: "Downtime", val: "None" },
  ...
  "mesopeels-carbon-peel": {
    ...
    heroRating: "4.9 Â· Rated by 310+ patients",
    heroImage: "/services/mesopeelscarbonpeel/1.webp",
    performedByLabel: "ðŸ‘©â€âš•ï¸ Performed by",
    performedByName: "TREATMENT BY",
    performedBySub: "Safe â€¢ Ethical â€¢ Personalised",
    stats: [
      { n: "4â€“6", l: "Sessions recommended" },
      { n: "0â€“2", l: "Days downtime" },
    ...
    benefits: [
      { icon: "ðŸ§¬", b: "Cellular Renewal", d: "Stimulates healthy skin regeneration and smoother texture." },
      { icon: "ðŸ§ª", b: "Personalised Peeling", d: "Medical-grade peel strength tailored to your skin." },
      { icon: "âš¡", b: "Deep Pore Purification", d: "Removes excess oil, debris, and surface impurities." },
      { icon: "âœ¨", b: "Brighter & Refined Skin", d: "Improves clarity, texture, and overall skin radiance." }
    ],
    ...
    deviceName: "Helios III Q-Switched Laser & MesoesteticÂ® Peels",
    deviceSub: "FDA CLEARED â€¢ MEDICAL-GRADE â€¢ PROFESSIONAL SKIN RESURFACING",
    deviceDesc: "The Helios III Q-Switched ND:YAG Laser works together with MesoesteticÂ® medical peels to deliver a dual-action skin renewal treatment. While the laser targets excess pigment, carbon particles, and impurities, the peel exfoliates damaged skin, improves texture, and stimulates healthy cellular renewal for clearer, smoother, and more radiant skin.",
    deviceFeatures: ["Q-Switched ND:YAG Laser", "MesoesteticÂ® Medical Peels", "Medical Skin Resurfacing", "Precision Skin Renewal"],
    ...
    sessionPlanDesc: "A personalised treatment programme of 4â€“6 sessions, scheduled every 2â€“3 weeks, gradually improves skin clarity, texture, pore size, and pigmentation while maintaining your skin's natural balance.",
    sessionPlanSteps: [
    ...
    timelineItems: [
      ...
      { when: "Day 3â€“5", what: "Dead skin sheds naturally. Pores appear cleaner, oil production becomes more balanced, and skin looks brighter." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹6,500 / session" },
      { label: "Duration", val: "45â€“60 minutes" },
      { label: "Recommended", val: "4â€“6 sessions" },
      { label: "Frequency", val: "Every 2â€“3 weeks" },
  ...
  "laser-pigment-reduction": {
    ...
    heroRating: "4.8 Â· Rated by 220+ patients",
    heroImage: "/services/laser-pigment-reduction/1.webp",
    performedByLabel: "ðŸ‘©â€âš•ï¸ Performed by",
    performedByName: "Laser Specialist",
    performedBySub: "Medical Grade â€¢ Safe â€¢ Precise",
    stats: [
      { n: "3â€“6", l: "Sessions recommended" },
      { n: "1â€“3", l: "Days micro-flaking" },
    ...
    benefits: [
      { icon: "ðŸ§¬", b: "Precision Pigment Targeting", d: "Breaks down excess melanin while protecting healthy skin." },
      { icon: "ðŸŽ¯", b: "Even Skin Tone", d: "Reduces pigmentation for a brighter, more balanced complexion." },
      { icon: "âœ¨", b: "Natural Pigment Clearance", d: "Your body gradually removes fragmented pigment after treatment." },
      { icon: "ðŸ›¡ï¸", b: "Safe for Indian Skin", d: "Doctor-calibrated settings minimise the risk of post-inflammatory pigmentation." }
    ],
    ...
    deviceSub: "FDA CLEARED â€¢ FRACTIONAL ND:YAG â€¢ MEDICAL GRADE LASER",
    ...
    comparisonRows: [
      ...
      { label: "Sessions", ours: "Clears spots in 3â€“5 targeted treatments", standard: "Requires 10+ sessions with low progress" },
    ...
    timelineItems: [
      ...
      { when: "Day 3â€“5", what: "Pigment rise causes micro-flaking (feels like coffee grounds)." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹8,000 / session" },
      { label: "Duration", val: "30â€“45 minutes" },
      { label: "Recommended", val: "3â€“6 sessions" },
      { label: "Frequency", val: "Every 4 weeks" },
      { label: "Downtime", val: "1â€“3 days micro-flaking" },
      { label: "Performed by", val: "Dermatologist" }
    ],
    ctaImage: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1600&h=900&fit=crop&auto=format",
    beforeAfter: {
  ...
  "laser-scar-reduction": {
    ...
    heroRating: "4.9 Â· Rated by 180+ patients",
    ...
    stats: [
      { n: "4â€“6", l: "Sessions recommended" },
      { n: "2â€“4", l: "Days recovery redness" },
      { n: "3â€“4 Weeks", l: "Visible skin renewal" },
    ...
    benefits: [
      { icon: "ðŸ§¬", b: "Dermal remodeling", d: "Stimulates healthy collagen remodeling" },
      { icon: "ðŸŽ¯", b: "Precision Targeting", d: "Targets deep scar tissue with calibrated laser energy." },
      { icon: "âš¡", b: "Fractional healing", d: "Healthy surrounding skin supports faster healing" },
      { icon: "âœ¨", b: "Texture smoothing", d: "Improves uneven skin texture for a smoother appearance." }
    ],
    ...
    deviceSub: "FDA Cleared Â· Medical Resurfacing Â· High-Precision Scar Targeting",
    ...
    comparisonRows: [
      ...
      { label: "Improvement", ours: "50%â€“80% texture lift in 4â€“6 sessions", standard: "Superficial skin softening only" },
    ...
    sessionPlanDesc: "A program of 4â€“6 sessions, spaced 4â€“6 weeks apart, yields significant texture improvement.",
    sessionPlanSteps: [
    ...
    timelineItems: [
      ...
      { when: "Day 2â€“4", what: "Tiny micro-crusts naturally shed as new skin begins to emerge. Mild tightness is normal." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹12,000 / session" },
      { label: "Duration", val: "60 minutes" },
      { label: "Recommended", val: "4â€“6 sessions" },
      { label: "Frequency", val: "Every 4â€“6 weeks" },
      { label: "Downtime", val: "2â€“4 days (redness/bronzing)" },
      { label: "Performed by", val: "Medical Aesthetic Team" }
    ],
    ctaImage: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1600&h=900&fit=crop&auto=format",
    beforeAfter: {
  ...
  "phototherapy": {
    ...
    heroRating: "4.9 Â· Rated by 150+ patients",
    heroImage: "/services/phototherapy/1.webp",
    performedByLabel: "ðŸ‘©â€âš•ï¸ Performed by",
    performedByName: "Dermatologist Supervised",
    performedBySub: "Safe â€¢ Gentle â€¢ Medical Grade",
    stats: [
      { n: "6â€“10", l: "Sessions recommended" },
      { n: "0", l: "Days downtime" },
    ...
    benefits: [
      { icon: "ðŸ§¬", b: "Cellular activation", d: "Increases ATP production to support cellular repair." },
      { icon: "ðŸ›¡ï¸", b: "Acne Defense", d: "Helps eliminate acne-causing bacteria and reduces active breakouts." },
      { icon: "âš¡", b: "Redness Relief", d: "Calms inflammation, reduces redness, and soothes sensitive skin." },
      { icon: "ðŸŒŠ", b: "Collagen Support", d: "Stimulates collagen production to strengthen and repair skin tissue." }
    ],
    ...
    deviceSub: "FDA Cleared Â· Multi-Award LED System Â· Hospital Grade",
    ...
    sessionPlanDesc: "A series of 6â€“10 sessions, twice weekly, delivers optimal results for acne and inflammatory conditions.",
    sessionPlanSteps: [
    ...
    timelineItems: [
      ...
      { when: "Day 2â€“3", what: "Active breakouts begin to settle with reduced redness and inflammation." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹2,500 / session" },
      { label: "Duration", val: "45 minutes" },
      { label: "Recommended", val: "6â€“10 sessions" },
      { label: "Frequency", val: "1â€“2 times per week" },
      { label: "Downtime", val: "None" },
  ...
  "excimer-laser": {
    ...
    heroRating: "4.8 Â· Rated by 120+ patients",
    heroImage: "/services/excimer-laser/1.webp",
    performedByLabel: "ðŸ‘©â€âš•ï¸ Performed by",
    performedByName: "Dermatologist Supervised",
    performedBySub: "Safe â€¢ Personalised â€¢ Professional",
    stats: [
      { n: "10â€“20", l: "Sessions recommended" },
      { n: "0", l: "Days downtime" },
      { n: "4â€“6 weeks", l: "Repigmentation may begin" },
      { n: "100%", l: "Doctor performed" }
    ],
    whatIsThisTitle: "This is not",
    ...
    benefits: [
      { icon: "ðŸ”¬", b: "Monochromatic UVB", d: "Concentrated 308nm light targets only the lesion" },
      { icon: "âœ¨", b: "Melanocyte Activation", d: "Stimulates melanocyte activity to encourage repigmentation." },
      { icon: "ðŸ›¡ï¸", b: "Local Immune Control", d: "Modulates overactive immune cells within affected skin." },
      { icon: "ðŸŽ¯", b: "Precision Targeting", d: "Delivers UVB only to affected skin while protecting surrounding tissue." }
    ],
    ...
    deviceSub: "FDA Cleared Â· Monochromatic UVB Â· Autoimmune Skin Solution",
    ...
    sessionPlanDesc: "Sessions are brief and performed 2 to 3 times a week. Significant results are usually seen in 10â€“20 sessions.",
    sessionPlanSteps: [
    ...
    timelineItems: [
      { when: "Immediately", what: "Most patients experience little to no discomfort. Mild pinkness may appear for 12â€“24 hours." },
      { when: "Week 2", what: "Psoriasis scaling begins to reduce and plaques gradually soften." },
      { when: "Week 4â€“6", what: "Visible improvement begins based on the treated condition, with early repigmentation often seen in vitiligo." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹3,000 / session" },
      { label: "Duration", val: "15â€“30 minutes" },
      { label: "Recommended", val: "10â€“20 sessions" },
      { label: "Frequency", val: "2â€“3 times per week" },
      { label: "Downtime", val: "None" },
      { label: "Performed by", val: "Dermatologist" }
    ],
    ctaImage: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1600&h=900&fit=crop&auto=format",
  ...
  "laser-hair-reduction": {
    ...
    benefits: [
      { icon: "â­", b: "Triple Wavelength", d: "Combines 755nm, 810nm & 1064nm wavelengths for comprehensive hair reduction." },
      { icon: "â„ï¸", b: "ICE Plusâ„¢ cooling", d: "Continuous contact cooling helps maximize comfort while protecting the skin." },
      { icon: "ðŸ“¡", b: "In-Motion sweeps", d: "Continuous sweeping motion delivers even energy for greater treatment comfort." },
      { icon: "ðŸ›¡ï¸", b: "Wide Skin Compatibility", d: "Suitable for a wide range of skin tones with dermatologist-guided treatment." }
    ],
    ...
    deviceSub: "FDA Cleared Â· Award-Winning SHRâ„¢ Technology Â· Sapphire Cooling",
    deviceDesc: "The Soprano Titanium combines Alexandrite (755nm), Diode (810nm), and Nd:YAG (1064nm) wavelengths in a single handpiece. Its ICE Plusâ„¢ sapphire cooling technology helps maximize comfort while delivering effective hair reduction across a wide range of skin tones.",
    deviceFeatures: ["755nm â€¢ 810nm â€¢ 1064nm", "ICE Plusâ„¢ Sapphire Cooling", "SHRâ„¢ In-Motion Technology", "Suitable for Multiple Skin Types"],
    ...
    comparisonRows: [
      ...
      { label: "Pain Level", ours: "SHRâ„¢ sweeping motion with enhanced comfort", standard: "Higher discomfort with single-shot systems" },
      { label: "Cooling Tip", ours: "ICE Plusâ„¢ continuous sapphire cooling", standard: "Basic air cooling or limited cooling" },
    ...
    sessionPlanDesc: "Hair follicles are treated during their active growth phase. Most patients achieve significant long-term hair reduction over a series of 6â€“8 sessions.",
    sessionPlanSteps: [
      ...
      { n: "02", label: "Laser Hair Reduction Treatment", duration: "30â€“90 min", detail: "A cooling gel is applied and the laser handpiece glides smoothly over the treatment area, delivering controlled energy to the hair follicles while maximizing comfort." },
    ...
    timelineDesc: "Treated hairs gradually shed over the following 1â€“2 weeks, while hair regrowth becomes slower and finer with each session.",
    timelineItems: [
      { when: "Immediately", what: "Mild redness around the hair follicles is normal and usually settles within a few hours." },
      { when: "Day 7â€“14", what: "Treated hairs naturally shed from the follicles over the next 1â€“2 weeks." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹4,500 / session" },
      { label: "Duration", val: "30â€“90 minutes" },
      { label: "Recommended", val: "6â€“8 sessions" },
      { label: "Frequency", val: "Every 4â€“6 weeks" },
      { label: "Downtime", val: "None" },
      { label: "Performed by", val: "Aesthetic Therapist" }
    ],
  ...
  "muscle-sculpting": {
    ...
    heroRating: "4.8 Â· Rated by 160+ patients",
    ...
    whatIsThisDesc2: "During a single 30-minute session, the target muscles contract approximately 20,000 times. This intense workload forces the muscle tissue to adapt, leading to deep remodeling of its inner structureâ€”resulting in muscle building and simultaneous localized fat reduction.",
    benefits: [
      { icon: "ðŸ’ª", b: "Supramaximal contraction", d: "Stimulates 100% of muscle fibers (workouts reach 40%)" },
      { icon: "ðŸ“ˆ", b: "Core Strength Enhancement", d: "Strengthens abdominal and core muscles to improve posture and stability." },
      { icon: "âœ¨", b: "Non-surgical lifting", d: "Firm and round glutes or define abdomen safely" },
      { icon: "ðŸ”¥", b: "Fat Metabolism Boost", d: "Intense muscle contractions stimulate natural fat metabolism around the treated area." }
    ],
    ...
    deviceSub: "FDA Cleared Â· Medical-Grade HIFEM Â· Non-Invasive Toning",
    deviceDesc: "The HIFEM system penetrates deep into the subcutaneous tissue, inducing rapid muscle contractions. HIFEM technology delivers supramaximal muscle contractions that strengthen targeted muscles while stimulating natural fat metabolismâ€”creating a firmer, more sculpted body without surgery or downtime.",
    ...
    timelineDesc: "Muscle contractions occur immediately, while visible definition gradually develops over the following 4â€“6 weeks.",
    timelineItems: [
      { when: "Immediately", what: "Feels like you've completed an intense core workout. Mild muscle fatigue is normal." },
      { when: "Day 2â€“3", what: "Target area feels tighter and core posture feels stronger." },
  ...
  "exosomes-prp-gfc": {
    ...
    benefits: [
      { icon: "ðŸ§¬", b: "Bio-regenerative healing", d: "Uses natural cell-signaling pathways for repair" },
      { icon: "ðŸ§ª", b: "Purified Growth Factors", d: "Highly concentrated growth factors support tissue repair and regeneration." },
      { icon: "âœ¨", b: "Cellular Communication", d: "Exosomes deliver regenerative signals that support collagen production and tissue repair." },
      { icon: "ðŸŒ±", b: "Hair Follicle Stimulation", d: "Helps reactivate dormant follicles to encourage healthier hair growth." }
    ],
    ...
    deviceSub: "Medical Centrifuge Â· Sterile Preparation Â· Premium Exosomes",
    ...
    sessionPlanDesc: "A typical treatment plan includes 3â€“4 sessions performed 4 weeks apart, followed by maintenance treatments as recommended by your dermatologist.",
    sessionPlanSteps: [
    ...
    timelineDesc: "Hair follicles and collagen remodeling continue to improve gradually over the following 3â€“6 months.",
    timelineItems: [
      { when: "Immediately", what: "Mild redness, swelling, or tenderness may occur and typically settles within 12â€“24 hours." },
    ...
    ctaQuickFacts: [
      { label: "Price from", val: "â‚¹10,000 (PRP) / â‚¹18,000 (GFC)" },
      { label: "Duration", val: "60â€“75 minutes" },
      { label: "Recommended", val: "3â€“4 sessions" },
      { label: "Frequency", val: "Every 4 weeks" },
      { label: "Downtime", val: "12â€“24 hours (swelling/bumps)" },
      { label: "Performed by", val: "Medical Aesthetic Team" }
    ],
    ctaImage: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1600&h=900&fit=crop&auto=format",
    beforeAfter: {
