...
export const STEPS: Step[] = [
  ...
  { Icon: Sparkles, n: "04", phase: "Experience", emoji: "✨", color: "#C9956A", desc: "Calm music. Warm lighting. Every step is narrated clearly so nothing is unexpected. You remain in control." },
  ...
  { Icon: Award, n: "06", phase: "Results", emoji: "🌟", color: "#A87060", desc: "Results are documented with clinical photography — honouring your journey and the confidence you carry home." },
];
