  ...
  return (
    <section className="py-6 md:py-12 bg-[#FAF7F2]">
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between md:justify-start items-start md:items-end mb-6 gap-8 px-4 sm:px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
          <FadeUp>
          ...
          <FadeUp delay={0.1}>
            <div className="md:border-l border-[#2C1810]/15 md:pl-8 py-1">
              <p className="text-[#C9956A] lg:text-[#2C1810] text-base leading-relaxed" style={B}>
                <span className="inline-block mr-2.5 md:mr-0">Real stories.</span><br className="hidden md:block" />
                <span className="inline-block mr-2.5 md:mr-0">Real people.</span><br className="hidden md:block" />
                <span className="inline-block">Real confidence.</span>
              </p>
            </div>
          </FadeUp>
        </div>
        ...
        <FadeUp delay={0.5}>
          <div className="mt-6 flex justify-center px-4 sm:px-6 md:px-16 lg:px-24">
            <p className="text-[11px] tracking-[0.2em] md:tracking-[0.3em] uppercase text-[#C9956A] font-medium" style={M}>5,000+ Transformations and Counting</p>
          </div>
        </FadeUp>
