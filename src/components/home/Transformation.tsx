  ...
  return (
    <section className="py-6 md:py-12 bg-[#FAF7F2]">
      <div className="w-full">
        ...
        <div className="bg-white p-2 md:p-0 flex flex-col gap-2 md:gap-1 w-full shadow-sm">
          {/* Top Row: Sofia */}
          <FadeUp delay={0.2} className="w-full">
            <div className="flex flex-col md:flex-row w-full gap-2 md:gap-0 bg-white">
              {/* Image */}
              ...
              <div className="w-full md:w-1/2 bg-[#FAF7F2] flex flex-col justify-center p-6 md:p-10 lg:p-12">
                <p className="text-[10px] tracking-[0.25em] uppercase text-[#C9956A] mb-4 font-medium" style={M}>Featured Story</p>
                ...
                <a href="#stories" className="group inline-flex items-center gap-2 text-[10px] tracking-[0.2em] uppercase text-[#C9956A] font-medium transition-opacity hover:opacity-80 mt-auto md:mt-0" style={M}>
          ...
          <div className="flex flex-col lg:flex-row w-full gap-2 md:gap-1 bg-white">

            {/* Amara */}
            <FadeUp delay={0.3} className="w-full lg:w-1/2">
              <div className="flex flex-col sm:flex-row h-full gap-2 md:gap-0 bg-white">
                ...
                <div className="w-full sm:w-1/2 bg-[#FAF7F2] flex flex-col justify-center p-5 md:p-6 lg:p-8">
                  <p className="text-[10px] tracking-[0.25em] uppercase text-[#C9956A] mb-3 flex items-center gap-2 font-medium" style={M}>
                    Story 🌿
                  </p>
        ...
        <FadeUp delay={0.5}>
          <div className="mt-12 flex justify-center px-4 sm:px-6 md:px-16 lg:px-24">
            <p className="text-[10px] tracking-[0.2em] md:tracking-[0.3em] uppercase text-[#C9956A] font-medium" style={M}>3,800+ Transformations and Counting</p>
          </div>
        </FadeUp>
