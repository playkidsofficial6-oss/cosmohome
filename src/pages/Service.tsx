                  ...
                  <div className="relative inline-block w-full sm:w-auto">
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-[#2C1810] whitespace-nowrap" style={B}>
                        {slug === "inbody-270" ? "First InBody 270 Center in the District" : "First InBody 380 Center in the District"}
                      </span>
                    </motion.div>
                  </div>
                )}
            ...
            <div className="grid lg:grid-cols-[1fr_auto] gap-14 lg:gap-24 items-center">
              <FadeUp>
                ...
                <div className="flex flex-col sm:flex-row gap-3.5 mb-8">
                  <motion.a href={service.ctaButtonLink || getWhatsAppUrl()} target="_blank" rel="noopener noreferrer"
                  ...
                  <motion.a href={service.ctaSecondaryButtonLink || getWhatsAppUrl()} target="_blank" rel="noopener noreferrer"
