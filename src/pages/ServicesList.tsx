...
export default function ServicesListPage() {
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[90vh] lg:min-h-screen flex flex-col justify-center bg-[#FAF6F0] pt-24 md:pt-36 pb-6 md:pb-20 overflow-hidden">
      ...
      <section className="pt-12 pb-6 md:py-24 px-6 md:px-16 bg-[#FAF7F2]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
